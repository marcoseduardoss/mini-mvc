            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <c:otherwise>
                  ...
                  <p class="card-category">Informe os dados do usuário</p>
                </div>
                <div class="card-body">
                  <form action="<%=request.getContextPath()%>/restrict/controllerServlet" 
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input value="${usuario.login}" name="login" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Primeira Senha</label>
                          <input value="${usuario.senha}" name="senha" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input value="${usuario.telefone}" type="text" name="telefone" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" value="Brasil" class="form-control" disabled>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>Sobre</label>
                          <div class="form-group">
                            <label class="bmd-label-floating"> Incluir o perfil do usuário.</label>
		            ...
		            <a href="<%=request.getContextPath()%>/restrict/controllerServlet?controle=UsuarioAction&operacao=listar">
