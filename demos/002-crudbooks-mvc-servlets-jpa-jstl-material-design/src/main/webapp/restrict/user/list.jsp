			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">Usuários</a>
					</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
											...
											<a
												href="<%=request.getContextPath()%>/restrict/controllerServlet?controle=UsuarioAction&operacao=prepararCadastro"
												class="btn btn-outline-primary pull-right btn-sm"> Novo
											</a> <a class="mdl-button mdl-button--raised">Submit</a>
												...
												<tbody>
													<c:forEach var="u" begin="0" items="${usuarios}">
														<tr>
															...
															<td>${u.email}</td>
															<td><a
																href="../restrict/controllerServlet?controle=UsuarioAction&operacao=prepararAlteracao&id=${u.id}">Alterar</a></td>
															<td><a
																href="../restrict/controllerServlet?controle=UsuarioAction&operacao=remover&id=${u.id}">Remover</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
